...
class UserIdentity extends CUserIdentity {
    ...
    public function authenticate() {
        ...
        $model = LcsUsers::model()->find("user_name=:user_name and user_password=:user_password and user_type = 'Administrator'", array(':user_name'=>$this->username, ':user_password'=>md5($this->password)));
        if(!$model){
