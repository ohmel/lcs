...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" ng-app="oSystems">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo Yii::app()->request->baseUrl; ?>/bower_components/bootstrap/dist/css/bootstrap.css">
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/bower_components/ng-notify/dist/ng-notify.min.css" />
            <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/bower_components/ngDialog/css/ngDialog.min.css" />
...
//                        array('label' => 'About', 'url' => array('/site/page', 'view' => 'about')),
            ...
            <div id="footer">
                Copyright &copy; <?php echo date('Y'); ?> by Ohmel Paguirigan<br/>
